      ...
      >
        ...
        <div className={"row row-cols-auto row-price-list gx-5 "}>
          <div className='col col-price-list'>
            <Membership name={"polumjesecna"} description={["3x tjedno"]} price={75} />
          </div>

          <div className='col col-price-list'>
            <Membership name={"mjesecna"} description={["Neograničen pristup teretani"]} price={150} />
          </div>

          <div className='col col-price-list'>
            <Membership name={"Squash"} description={["1 sat"]} price={100} />
          </div>

          <div className='col col-price-list'>
            <Membership name={"premium"} description={["Neograničen pristup teretani", "1 besplatan squash termin tjedno (potrebna najava)"]} price={225} />
          </div>
          ...
          >
            ...
            <Membership name={"godisnja"} description={["Neograničen pristup teretani"]} price={1400} />
          </div>
